...
condition:
    $genep1 and $contep1 and $contep2 or ($genep2 at entrypoint and ($contep3 in (entrypoint..entrypoint + 65))) or ($genep3 at entrypoint and ($contep4 in (entrypoint..entrypoint + 26)))
